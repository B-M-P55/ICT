...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] === 'login') {
    $identifier = $conn->real_escape_string(trim($_POST['login_identifier']));
    $password   = $_POST['login_password'];

    // Search in tbl_user by email or phone_number
    $userQuery = $conn->query("SELECT * FROM tbl_user WHERE (email = '$identifier' OR phone_number = '$identifier') AND account_status = 'active' LIMIT 1");
    ...
    // Search in tbl_admin
    $adminQuery = $conn->query("SELECT * FROM tbl_admin WHERE (email = '$identifier' OR phone_number = '$identifier') LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] === 'signup') {
    ...
    if ($password !== $confirmPassword) {
        ...
        $emailCheck = $conn->query("SELECT userID FROM tbl_user WHERE email = '$email' LIMIT 1");
        ...
        if ($emailCheck && $emailCheck->num_rows > 0) {
            ...
            $insertSql = "INSERT INTO tbl_user (first_name, last_name, email, password, phone_number, address, account_status) 
                          VALUES ('$firstName', '$lastName', '$email', '$hashedPassword', '$phone', '', 'active')";
...
<head>
    ...
    <style>
        /* Glassmorphism background styles matching the order card design */
        body {
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-buttons">
            <button class="order-btn" onclick="window.location.href='checkout.php'">ORDER NOW</button>
        ...
        <div class="auth-card">
            ...
            <div class="tab-content" id="authTabsContent">
                ...
                <div class="tab-pane fade <?php echo empty($signupError) && empty($signupSuccess) ? 'show active' : ''; ?>" id="login-pane" role="tabpanel">
                    <div class="section-banner mb-4 text-center">
                        <h2>Welcome Back</h2>
                    </div>
                    ...
                    <form id="loginForm" method="POST" action="">
                        ...
                        <div class="mb-3">
                            <label for="loginEmail" class="form-label">Email or Phone Number <span class="required">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa-solid fa-envelope"></i></span>
                                <input type="text" name="login_identifier" class="form-control" id="loginEmail" placeholder="Enter your email or phone" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="login_password" class="form-control login-pass-field" id="loginPassword" placeholder="Enter your password" required>
                                <button class="btn btn-outline-secondary toggle-password-btn" type="button" onclick="togglePassword('loginPassword', this)">
                ...
                <div class="tab-pane fade <?php echo !empty($signupError) || !empty($signupSuccess) ? 'show active' : ''; ?>" id="signup-pane" role="tabpanel">
                    ...
                    <?php if (!empty($signupError)): ?>
                        <div class="alert alert-danger py-2"><?php echo $signupError; ?></div>
                    <?php endif; ?>

                    <?php if (!empty($signupSuccess)): ?>
                        <div class="alert alert-success py-2"><?php echo $signupSuccess; ?></div>
                    <?php endif; ?>
                    ...
                    <form id="signupForm" method="POST" action="">
                        ...
                        <div class="mb-3">
                            <label for="signupPhone" class="form-label">Phone Number <span class="required">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa-solid fa-phone"></i></span>
                                <input type="tel" name="phone_number" class="form-control" id="signupPhone" placeholder="09-xxxxxxxxx" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="signupEmail" class="form-label">Email Address <span class="required">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa-solid fa-envelope"></i></span>
                                <input type="email" name="email" class="form-control" id="signupEmail" placeholder="example@gmail.com" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary toggle-password-btn" type="button" onclick="togglePassword('signupPassword', this)">
                                    <i class="fa-solid fa-eye"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary toggle-password-btn" type="button" onclick="togglePassword('confirmPassword', this)">
                                    <i class="fa-solid fa-eye"></i>
                                </button>
                            </div>
                        </div>
